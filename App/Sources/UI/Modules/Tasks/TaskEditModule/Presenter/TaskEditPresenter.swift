...
final class TaskEditPresenter: TaskEditModuleInputProtocol {
    ...
    private var router: TaskEditRouterInputProtocol
    
    private var action: TaskEditActionType = .create
    private var task: ProjectTask?
    private var project: Project?
    private var employee: Employee?
    private var isOpenedFromProject = false
    
    init(interactor: TaskEditInteractorInputProtocol, router: TaskEditRouterInputProtocol) {
...
// MARK: - TaskEditViewOutputProtocol
extension TaskEditPresenter: TaskEditViewOutputProtocol {
    func viewDidLoad() {
    ...
    func textFieldDidChange(textFieldType: TaskEditFieldType,text: String?) {
...
extension TaskEditPresenter: ProjectSelectionOutputProtocol {
...
extension TaskEditPresenter: EmployeeSelectionOutputProtocol {
