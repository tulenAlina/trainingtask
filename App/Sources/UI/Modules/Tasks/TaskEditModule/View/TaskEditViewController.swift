...
protocol TaskEditViewInputProtocol: AnyObject {
    ...
    func updateValidationStyle(textFieldType: TaskEditFieldType, isValid: Bool)
    func startLoading()
    func stopLoading()
    func showAlert(_ message: String)
}

protocol TaskEditViewOutputProtocol {
    func viewDidLoad()
...
final class TaskEditViewController: BaseViewController, TaskEditViewInputProtocol {
    var output: TaskEditViewOutputProtocol
...
private extension TaskEditViewController {
    func fieldType(for textField: UITextField) -> TaskEditFieldType? {
        switch textField {
