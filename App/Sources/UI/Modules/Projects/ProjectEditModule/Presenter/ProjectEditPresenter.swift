...
final class ProjectEditPresenter: ProjectEditModuleInputProtocol {
    weak var view: ProjectEditViewInputProtocol?
    weak var output: ProjectEditModuleOutputProtocol?
    private let interactor: ProjectEditInteractorInputProtocol
    private var router: ProjectEditRouterInputProtocol
    
    private var action: ProjectEditActionType = .create
    private var project: Project?
    
    init(interactor: ProjectEditInteractorInputProtocol, router: ProjectEditRouterInputProtocol) {
...
// MARK: - ProjectEditViewOutputProtocol
extension ProjectEditPresenter: ProjectEditViewOutputProtocol {
    func viewDidLoad() {
...
// MARK: - Private
private extension ProjectEditPresenter {
