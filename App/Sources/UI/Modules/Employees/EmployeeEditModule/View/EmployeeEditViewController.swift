...
protocol EmployeeEditViewInputProtocol: AnyObject {
    ...
    func updateValidationStyle(textFieldType: EmployeeEditFieldType, isValid: Bool)
    func startLoading()
    func stopLoading()
    func showAlert(_ message: String)
}

protocol EmployeeEditViewOutputProtocol {
    func viewDidLoad()
...
final class EmployeeEditViewController: BaseViewController, EmployeeEditViewInputProtocol {
    var output: EmployeeEditViewOutputProtocol
...
// MARK: - Private
private extension EmployeeEditViewController {
    func fieldType(for textField: UITextField) -> EmployeeEditFieldType? {
        switch textField {
